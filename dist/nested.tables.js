(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("nestedTables", [], factory);
	else if(typeof exports === 'object')
		exports["nestedTables"] = factory();
	else
		root["nestedTables"] = factory();
})(self, () => {
...
__webpack_require__.d(__webpack_exports__, {
  "TableHierarchy": () => (/* reexport */ TableHierarchy)
});

;// CONCATENATED MODULE: ./src/script/IdParser.js
/**
 *
...
class IdParser {
  constructor(elementIdPar, patternPar) {
    ...
    this.patternOccurrence = this.countPatternOccurrence();
    this.parsedIds = [];
  }
  ...
  setElementIdWithOccurrence(eleId) {
  ...
  parse() {
    ...
    for (let i = this.patternOccurrence; i > 0; i--) {
      // find and delete first "tab_" occurrence in id
      let firstIndexOfTabPosition =
        tempElementId.indexOf('tab_') + 'tab_'.length;
      tempElementId = tempElementId.substring(
        firstIndexOfTabPosition,
        tempElementId.length
      );

      // find and delete first "row_" occurrence in id
      let rowPosition =
        tempElementId.indexOf(this.pattern + '_') + (this.pattern + '_').length;
      tempElementId = tempElementId.substring(
        rowPosition,
        tempElementId.length
      );
      ...
      if (tempElementId.indexOf('tab_') !== -1) {
        tabId = tempElementId.substring(
          tempElementId.indexOf('tab_') + 'tab_'.length,
          tempElementId.indexOf('row_') - 1
        );
...
;// CONCATENATED MODULE: ./src/img/arrow_right.png
/* harmony default export */ const arrow_right = ("data:image/png;base64,");
;// CONCATENATED MODULE: ./src/script/TableBuilder.js
      ...
      if (typeof tableDataInJson[k].data !== 'undefined') {
        ...
        if (tableMainHeader.indexOf('<th></th>') !== -1) {
          if (Object.keys(tableDataInJson[k].kids).length > 0) {
            TableMainBody +=
              '<td class="arrowContainer"><img src="' + arrow_right + '"></td>';
          } else {
            TableMainBody += '<td></td>';
          }
        }
...
;// CONCATENATED MODULE: ./src/script/NestedTables.js



var dataTable = __webpack_require__(83);
$.DataTable = dataTable;
